...
export class UserService extends BaseService {
  ...
  context?: HttpContext
    ...
    return this.apiUserAuthenticatePost$Response(params,context).pipe(
  ...
  context?: HttpContext
    ...
    return this.apiUserRegisterPost$Response(params,context).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }
  ...
  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiUserGrantRolePost()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiUserGrantRolePost$Response(params?: {
    userId?: number;
    roleId?: number;
  },
  context?: HttpContext
  ...
  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `apiUserGrantRolePost$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiUserGrantRolePost(params?: {
    userId?: number;
    roleId?: number;
  },
  context?: HttpContext
    ...
    return this.apiUserGrantRolePost$Response(params,context).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }
